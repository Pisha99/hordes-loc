export default [
...

  {
    ...
    description: {
      ...
      es: 'Una criatura sobrenatural unida a este muñeco alimenta el poder mágico disponible al portador.'
    }
  },
...

  {
    ...
    description: {
      ...
      es: 'Cuando los templarios derrotados fallan un objetivo divino, sueltan devoción espiritual en forma de un tótem personal como este para ayudar el bien.'
    }
  },
...

  {
    ...
    description: {
      ...
      es: 'Esta es una prisión con criaturas sobrenaturales que están increiblemente atadas. Generan un poder de sustancias mágicas con su risa innatural.'
    }
  },

  {
    ...
    description: {
      ...
      es: 'Un colectivo de mentes sobrenaturales que centran su poder mágico y lo otorgan al portador de su tótem. El Hive Mind cree que todas las criaturas deben someterse a su poder e intentan convencer al portador de que se unan a ellas.'
    }
  },

  {
    ...
    description: {
      ...
      es: 'Este es un avatar de una criatura sobrenatural. Algunos estudiantes dicen que Nganga\'s Serpent es dada a aquellos que son elegidos y son considerados dignos de grandeza; Sin embargo, otros estudiantes sugieren que esta es una forma por la cual las deidades intentan controlar y manipular a los mortales.'
    }
  },

  {
    ...
    description: {
      ...
      es: 'Se dice que estos huesos antiguos son pequeños fragmentos de un monstruo olvidado. Los huesos radían poder más allá de la imaginación.'
    }
  }
